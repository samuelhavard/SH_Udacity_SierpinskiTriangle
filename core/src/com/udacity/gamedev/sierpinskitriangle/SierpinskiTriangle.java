...
public class SierpinskiTriangle extends ApplicationAdapter {
    ...
    private void inscribeSierpinskiTriangle(ShapeRenderer renderer, float size, int recursion) {
        ...
        drawSierpinskiTriangle(renderer, corner1, corner2, corner3, recursion);
    }

    private void drawSierpinskiTriangle(ShapeRenderer renderer, Vector2 corner1, Vector2 corner2,
                                        Vector2 corner3, int recursion) {
        ...
        if (recursion == 1) {
            ...
            renderer.triangle(corner2.x, corner2.y, midpoint23.x, midpoint23.y, midpoint12.x, midpoint23.y);
            renderer.triangle(corner3.x, corner3.y, midpoint31.x, midpoint31.y, midpoint23.x, midpoint23.y);
        } else {
            drawSierpinskiTriangle(renderer, corner1, midpoint12, midpoint31, recursion - 1);
            drawSierpinskiTriangle(renderer, corner2, midpoint23, midpoint12, recursion - 1);
            drawSierpinskiTriangle(renderer, corner3, midpoint31, midpoint23, recursion - 1);
        }
    }
